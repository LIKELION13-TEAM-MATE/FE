...
function TapBarComponent() {
  ...
  return (
    <Container>
        <Icon src={currentPath === '/' ? homeIconColor : homeIcon} onClick={() => navigate('/')}/>
        <Icon src={currentPath === '/calendar' ? calendarIconColor : calendarIcon} onClick={() => navigate('/calendar')}/>
        <Icon src={plusIcon} onClick={() => navigate('/new')}/>
        <Icon src={currentPath === '/complete' ? folderIconColor : folderIcon} onClick={() => navigate('/complete')}/>
